    ...
    <body class="bg-travel-50 text-travel-950 min-h-screen">
        ...
        <main class="max-w-5xl mx-auto px-4 py-8">  
            <section class="bg-white rounded-xl shadow-sm border border-travel-100 p-6">
                <h1 class="font-display text-4xl font-bold text-travel-900 ">Travel Bucket List Manager</h1>
                ...
                <div class="mt-8 max-w-3xl">
                    <h3 class="font-display text-2xl font-semibold text-travel-900 ">About the application</h3>
